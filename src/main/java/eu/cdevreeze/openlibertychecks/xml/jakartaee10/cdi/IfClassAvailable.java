...
/**
 * If-class-available XML element wrapper.
 *
 * @author Chris de Vreeze
 */
public final class IfClassAvailable implements BeansXmlContent {

    private final AncestryAwareNodes.Element element;

    public IfClassAvailable(AncestryAwareNodes.Element element) {
        Preconditions.checkArgument(Names.JAKARTAEE_NS.equals(element.elementName().getNamespaceURI()));
        Preconditions.checkArgument(element.elementName().getLocalPart().equals("if-class-available"));
