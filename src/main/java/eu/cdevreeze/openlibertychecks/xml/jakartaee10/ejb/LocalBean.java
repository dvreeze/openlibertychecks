...
/**
 * Local-bean XML element wrapper.
 *
 * @author Chris de Vreeze
 */
public final class LocalBean implements EjbJarXmlContent {

    private final AncestryAwareNodes.Element element;

    public LocalBean(AncestryAwareNodes.Element element) {
        Preconditions.checkArgument(Names.JAKARTAEE_NS.equals(element.elementName().getNamespaceURI()));
        Preconditions.checkArgument(element.elementName().getLocalPart().equals("local-bean"));
